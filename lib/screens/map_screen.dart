...
class MapScreen extends StatefulWidget {
  ...
  MapScreen(
      {this.initialLocation = const PlaceLocation(latitude: 37.422, longitude: -122.084), this.isSelecting = false});
...
class _MapScreenState extends State<MapScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.isSelecting ? 'Pick a Location' : 'Location on Map'),
        actions: [
